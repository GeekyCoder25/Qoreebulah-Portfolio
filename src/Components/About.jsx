			...
			<main>
				<div className="main">
					...
					<p className="sub-text">
						...
						<span className="ii">love to create </span>
						<span className="ii">Unique User Experience and </span>Digital User
						Interface
					</p>
				</div>
				<div className="about-desc">
					<p>
						...
						interfaces. I am passionate about creating a user-centered design,
						gathering and translating user data into design decisions and
						products.
					</p>
					<p>
						My objective is to gather more experience and knowledge in niche,
						and to secure a career opportunity that expands my knowledge and
						fully utilize my knowledge, practice and skills, while ensuring
						result-oriented efforts in boosting the productivity of
						organizations.
					</p>
				</div>
				<div className="about-desc2">
					<p>
						I am happy to present my new website As before I am open for new
						projects worldwide!
					</p>
					<p>
						Would you like to have award winning site or unique design style,
						please say hi to me — <br />
						<a href="mailto:qoribullahabubakar@gmail.com">
				...
				<HorizontalMoving />
				<WorkExperience />
				<AboutMoving header={"Explore More"} text={"Contact"} />
				<Create />
			</main>
		</article>
	);
