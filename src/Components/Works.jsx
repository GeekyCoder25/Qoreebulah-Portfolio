...
const AboutMoving = (props) => {
    return (
        <section className="about-moving">
            ...
            <h1>
                <div>
                    <span className="ilyas"> {props.text} </span><span className="camar">-</span><span className="camar"> {props.text} </span><span className="camar">-</span><span className="ilyas"> {props.text} </span><span className="camar">-</span><span className="camar"> {props.text} </span><span className="camar">-</span><span className="ilyas"> {props.text} </span><span className="camar">-</span><span className="camar"> {props.text} </span>
                </div>
            </h1>
        </section>
    );
    ...
    return (
        <article className="works">
            ...
            <main>
                <div className="main">
                    <p className="no">11</p>
                    <p className="main-text">featured<br />works</p>
                </div>
                <div className="with-love-container">
                    <p className="with-love">The best from web interface, app interface & photoship art <br /><br />From Qoreeb with love.</p>
                </div>
            </main>
            <ProjectGrid
            ...
            />
            <ProjectGrid
                image1={Bb} image2={Space} image3={Cab} image4={Cake} image5={Glowing} image6={Dragon}
                heading1={'BB Collections'} heading2={'Space Home'} heading3={'Onis Cab App'} heading4={'Cake Face'} heading5={'Glowing Angel'} heading6={'Dragon Face Tatoo'}
                about1={'Bb Collections Website'} about2={'Space Home Manipulation'} about3={'Onis Cab App'} about4={'Cake Face Manipulation'} about5={'Glowing Angel Manipulation'} about6={'Dragon Face Tatto'}
                source1={'Landing page'} source2={'Photoshop'} source3={'Mobile App'} source4={'Photoshop Art'} source5={'Photoshop'} source6={'Photoshop'}
                year1={'2021'} year2={'2021'} year3={'2021'} year4={'2021'} year5={'2021'} year6={'2021'} />
