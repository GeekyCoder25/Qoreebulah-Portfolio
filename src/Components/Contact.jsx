    ...
    return (
        <article className="contact">
            ...
            <div className="contact-header">
                <p className="time" onLoad={handleDate}>{hour < 10 ? '0' +hour : hour}<span>:</span>{minute < 10 ? '0' + minute : minute}<span>:</span>{second < 10 ? '0' + second : second}</p><span className="hi">SAY HI</span>
