		...
		<div className="about">
			...
			<div className="about-absolute-container">
				<p className="about-text">
					I love Design, Art, and Technology. I'm a Product designer specialized
					in creating seamless user experiences and digital user interfaces. I
					am passionate about creating a user-centered design, gathering and
